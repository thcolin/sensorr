  ...
  if (pwa && display === 'app') {
    return (
      <div sx={Navigation.styles.app.element}>
        <RippleNavLink to='/' unstable_viewTransition onClick={location.pathname === '/' ? () => {} : handleAppNavigation} style={(location.pathname === '/' || location.pathname.startsWith('/movie') || location.pathname.startsWith('/collection')) ? Navigation.styles.app.active : {}}>
        ...
        <RippleNavLink to='/person/followed' unstable_viewTransition onClick={location.pathname === '/person/followed' ? () => {} : handleAppNavigation} style={location.pathname.startsWith('/person') ? Navigation.styles.app.active : {}}>
        ...
        <RippleNavLink to='/jobs' unstable_viewTransition onClick={location.pathname === '/jobs' ? () => {} : handleAppNavigation} style={({ isActive }) => isActive ? Navigation.styles.app.active : {}}>
        ...
        <RippleNavLink to='/settings' unstable_viewTransition onClick={location.pathname === '/settings' ? () => {} : handleAppNavigation} style={({ isActive }) => isActive ? Navigation.styles.app.active : {}}>
    ...
    return (
      <div sx={Navigation.styles.web.element}>
        <div ref={container} sx={Navigation.styles.web.container}>
          <NavLink onClick={handleWebNavigation} to="/" unstable_viewTransition style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Home</NavLink>
          <NavLink onClick={handleWebNavigation} to="/movie/library" unstable_viewTransition style={(location.pathname.startsWith('/movie') || location.pathname.startsWith('/collection')) ? Navigation.styles.web.active : {}}>Movies</NavLink>
          {location.pathname.startsWith('/movie') && (
            <div sx={Navigation.styles.web.secondary}>
              <Chevron />
              <NavLink onClick={handleWebNavigation} to="/movie/library" unstable_viewTransition style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Library</NavLink>
              <NavLink onClick={handleWebNavigation} to="/movie/discover" unstable_viewTransition style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Discover</NavLink>
              <NavLink onClick={handleWebNavigation} to="/movie/calendar" unstable_viewTransition style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Calendar</NavLink>
              <NavLink onClick={handleWebNavigation} to="/movie/trending" unstable_viewTransition style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Trending</NavLink>
              <NavLink onClick={handleWebNavigation} to="/movie/theatres" unstable_viewTransition style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Theatres</NavLink>
              <NavLink onClick={handleWebNavigation} to="/movie/requests" unstable_viewTransition style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Requests</NavLink>
            </div>
          )}
          <NavLink onClick={handleWebNavigation} to="/person/followed" unstable_viewTransition style={location.pathname.startsWith('/person') ? Navigation.styles.web.active : {}}>Stars</NavLink>
          {location.pathname.startsWith('/person') && (
            <div sx={Navigation.styles.web.secondary}>
              <Chevron />
              <NavLink onClick={handleWebNavigation} to="/person/followed" unstable_viewTransition style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Followed</NavLink>
              <NavLink onClick={handleWebNavigation} to="/person/trending" unstable_viewTransition style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Trending</NavLink>
            </div>
          )}
          <NavLink onClick={handleWebNavigation} to="/jobs" unstable_viewTransition style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Jobs</NavLink>
          <NavLink onClick={handleWebNavigation} to={device === 'mobile' ? '/settings' : '/settings/tmdb'} unstable_viewTransition style={location.pathname.startsWith('/settings') ? Navigation.styles.web.active : {}}>Settings</NavLink>
        </div>
      </div>
    )
  }
