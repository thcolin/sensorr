...
const Navigation = ({ display = 'web', ...props }) => {
  const { pwa, setHistoryResetIndex } = useDeviceContext()
  ...
  if (pwa && display === 'app') {
    return (
      <div sx={Navigation.styles.app.element}>
        <NavLink to='/' onClick={() => setHistoryResetIndex(window.history.state.idx + 1)} style={(location.pathname === '/' || location.pathname.startsWith('/movie') || location.pathname.startsWith('/collection')) ? Navigation.styles.app.active : {}}>
        ...
        <NavLink to='/person/followed' onClick={() => setHistoryResetIndex(window.history.state.idx + 1)} style={location.pathname.startsWith('/person') ? Navigation.styles.app.active : {}}>
        ...
        <NavLink to='/jobs' onClick={() => setHistoryResetIndex(window.history.state.idx + 1)} style={({ isActive }) => isActive ? Navigation.styles.app.active : {}}>
        ...
        <NavLink to='/settings' onClick={() => setHistoryResetIndex(window.history.state.idx + 1)} style={({ isActive }) => isActive ? Navigation.styles.app.active : {}}>
    ...
    return (
      <div sx={Navigation.styles.web.element}>
        <div ref={container} sx={Navigation.styles.web.container}>
          <NavLink onClick={scrollTo} to="/" style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Home</NavLink>
          <NavLink onClick={scrollTo} to="/movie/library" style={(location.pathname.startsWith('/movie') || location.pathname.startsWith('/collection')) ? Navigation.styles.web.active : {}}>Movies</NavLink>
          {location.pathname.startsWith('/movie') && (
            <div sx={Navigation.styles.web.secondary}>
              <Chevron />
              <NavLink onClick={scrollTo} to="/movie/library" style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Library</NavLink>
              <NavLink onClick={scrollTo} to="/movie/discover" style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Discover</NavLink>
              <NavLink onClick={scrollTo} to="/movie/calendar" style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Calendar</NavLink>
              <NavLink onClick={scrollTo} to="/movie/trending" style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Trending</NavLink>
              <NavLink onClick={scrollTo} to="/movie/theatres" style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Theatres</NavLink>
              <NavLink onClick={scrollTo} to="/movie/requests" style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Requests</NavLink>
            </div>
          )}
          <NavLink onClick={scrollTo} to="/person/followed" style={location.pathname.startsWith('/person') ? Navigation.styles.web.active : {}}>Stars</NavLink>
          {location.pathname.startsWith('/person') && (
            <div sx={Navigation.styles.web.secondary}>
              <Chevron />
              <NavLink onClick={scrollTo} to="/person/followed" style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Followed</NavLink>
              <NavLink onClick={scrollTo} to="/person/trending" style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Trending</NavLink>
            </div>
          )}
          <NavLink onClick={scrollTo} to="/jobs" style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Jobs</NavLink>
          <NavLink onClick={scrollTo} to="/settings" style={({ isActive }) => isActive ? Navigation.styles.web.active : {}}>Settings</NavLink>
        </div>
      </div>
    )
  }
