...
export default ({ ...props}) => (
  <div style={styles.element}>
    ...
    <div style={styles.emojis}>
      <Language />
      <Link to="/configure" style={styles.configure}>🎚</Link>
      <a href="https://github.com/thcolin/sensorr" target="_blank">
        <svg style={styles.github} viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
