...
export default {
  ...
  tmdb: {
    release_type: {
      premiere: emojize('🥂', 'Premiere'),
      limited: emojize('🔒', 'Limited'),
      theatrical: emojize('📽️', 'Theatrical'),
      digital: emojize('☁️', 'Digital'),
      physical: emojize('📀', 'Physical'),
      tv: emojize('📺', 'TV'),
    },
  },
  ui: {
    ...
    filters: {
      ...
      languages: emojize('🌐', 'Original Language'),
      spoken_languages: emojize('🗣️', 'Spoken Languages'),
