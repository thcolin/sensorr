...
export const light = {
  ...
  textLighter: raw['gray-700'],
  textLight: raw['gray-800'],
  text: raw['gray-900'],
  textDark: raw.blackLightest,
  textDarker: raw.blackLighter,
  textDarkest: raw.blackLight,
...
export const dark = {
  ...
  textLighter: raw.whiteDarker,
  textLight: raw.whiteDarkest,
  text: raw['gray-100'],
  textDark: raw['gray-200'],
  textDarker: raw['gray-300'],
  textDarkest: raw['gray-400'],
